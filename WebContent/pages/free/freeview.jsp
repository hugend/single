			...
			<div id="kboard-thumbnail-list">
				...
				<div class="kboard-list">
					<table>
						...
						<tbody>
							<%
								for (int i=20*(pageNo-1); i<pageNo*20; i++) {
									if(i<size){
				...
				<div class="pagination">
					<ul>
						...
						<%if(pageNo==1){ %>
							&laquo; Previous
						<%}else{ %>
							<a href="/single/fr/list.do?category=all&page=<%=pageNo-1%>">&laquo; Previous</a>
						<%} %>
						</li>
							<%for(int i=firstPage;i<=lastPage;i++){ 
								...
								<%}else{ %>
								<li><a href="/single/fr/list.do?category=all&page=<%=i%>"><%=i %></a></li>
							<%}} %>
						<li class="next">
						<%if(pageNo==totalPage){ %>
							Next &raquo;
						<%}else{ %>
							<a href="/single/po/fr/list.do?category=all&page=<%=pageNo+1 %>">Next &raquo;</a>
						<%} %>
						</li>
					</ul>
				</div>
